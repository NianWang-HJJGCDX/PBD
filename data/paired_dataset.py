...
class PairedDataset(BaseDataset):
    ...
    def initialize(self, opt):
        ...
        self.A_paths = sorted(make_dataset_paired(self.dir_A, opt.max_dataset_size))   # load images from '/path/to/data/trainA'
    ...
    def __getitem__(self, index):
        ...
        B_shortPath = A_name+'.jpg'  # for same name of haze and real-world images
        # B_shortPath = A_name.split('_')[0] + '_outdoor_GT.jpg'  # for OHAZE
        # B_shortPath = A_name.split('_')[0] + '_' +A_name.split('_')[1] + '_RGB.jpg'  # for HAZERD
        ...
        if os.path.exists(B_path):
            ...
            B_img = A_img
        A_img = A_img.resize((self.opt.fineSize, self.opt.fineSize), Image.BICUBIC)
        B_img = B_img.resize((self.opt.fineSize, self.opt.fineSize), Image.BICUBIC)
